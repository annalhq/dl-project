...
## Web App Usage
First, install the packages found in requirements.txt. 

Then, run the following command from this project's root directory:
...
<a href="#"> <img alt="Home Page" src="song_examples/ReggaeCorrect.png" width="400"> </a>
##### Disco: Bee Gees - Stayin' Alive .mp3
<a href="#"> <img alt="Home Page" src="song_examples/DiscoCorrect.png" width="400"> </a>
##### Metal: Bullet For My Valentine  - Tears Don't Fall.mp3
<a href="#"> <img alt="Home Page" src="song_examples/MetalCorrect.png" width="400"> </a>
##### Hip Hop: Macklemore & Ryan Lewis - Thrift Shop.mp3
<a href="#"> <img alt="Home Page" src="song_examples/HipHopCorrect.png" width="400"> </a>
##### Pop: Justin Bieber - Baby.mp3
<a href="#"> <img alt="Home Page" src="song_examples/PopCorrect.png" width="400"> </a>

##### Country: George Strait - Check yes or no.mp3
<a href="#"> <img alt="Home Page" src="song_examples/CountryCorrect.png" width="400"> </a>
### Example files with unsuccessful predictions:
##### Classical: Chopin - Nocturne.mp3 (Blues)
<a href="#"> <img alt="Home Page" src="song_examples/ClassicalIncorrect.png" width="400"> </a>

##### Rock: Learn To Fly - Foo Fighters.mp3 (Metal)
<a href="#"> <img alt="Home Page" src="song_examples/RockIncorrect.png" width="400"> </a>
